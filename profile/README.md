...
- **UI**
    - 페이지 : 디자인, 홈, 게시글 상세, 채팅방,  채팅 목록, 프로필
    - 공통 컴포넌트 : 게시글 템플릿, 버튼, 게시글
- **기능**
...
- **UI**
    - 페이지 : 게시글 작성, 게시글 수정, 게시글 상세, 게시글 검색, 404 페이지
...
| 회원가입 |
|----------|
|<img width="1239" alt="Screenshot 2024-05-29 at 5 46 05 PM" src="https://github.com/discipline-CINE/.github/assets/59007130/9303cd77-a67b-4a18-9f15-45724d90b45c">|
